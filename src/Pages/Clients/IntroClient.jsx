...
function IntroClient() {
  return (
    <div className="min-h-screen bg-[#D3C5E5] grid grid-cols-2 items-center sm:grid-cols-1 -mt-6  sm:-mt-20">
      ...
      <div className="z-10 max-w-max flex flex-col space-y-5 sm:p-10  sm:mt-5">
        ...
        <p className="text-md text-gray-500 sm:font-medium ">“To give real service you must add something which cannot be bought <br /> or measured with money, and that is sincerity and integrity.”</p>
      </div>
    </div>
  );
}
